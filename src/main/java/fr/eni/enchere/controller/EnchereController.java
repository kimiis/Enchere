...
//
//        objetService.insertObjet(objet.getDateD(), objet.getDateF(), objet.getPrix(), objet.getNom(), objet.getDescription(), u.getId(), objet.getIdRetrait(), objet.getIdType(), objet.getNbRoue(),objet.isEncastrable(),objet.isPortbale());
//        return "createObjet";
//    }
//
//
