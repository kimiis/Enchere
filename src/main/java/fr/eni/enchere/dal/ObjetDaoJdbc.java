...
private final String FIND_BY_TYPE = "SELECT * from Objet as o" +
        "    inner join Couleur C on C.Id = o.IdCouleur\n" +
        "    inner join Coupe C2 on C2.Id = o.idCoupe\n" +
        "    inner join Energie E on E.Id = o.IdEnergie\n" +
        "    inner join Localisation L on L.Id = o.IdLocalisation\n" +
        "    inner join Marque M on M.Id = o.IdMarque\n" +
        "    inner join Taille T on T.Id = o.IdTaille where T.Nom = :typeName";
private final String FIND_BY_ID = "SELECT * FROM Objet as o" +
        ...
        "    inner join Localisation L on L.Id = o.IdLocalisation\n" +
        "    inner join Marque M on M.Id = o.IdMarque\n" +
        "    inner join Taille T on T.Id = o.IdTaille WHERE o.id =:idObjet";
